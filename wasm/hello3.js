...
var wasmMemory;
var wasmTable = new WebAssembly.Table({"initial": 4, "maximum": 4 + 0, "element": "anyfunc"});
var ABORT = false;
var EXITSTATUS = 0;
...
var DYNAMIC_BASE = 5245808, DYNAMICTOP_PTR = 2768;
...
var wasmBinaryFile = "hello3.wasm";
...
var asmLibraryArg = {"b": _emscripten_memcpy_big, "a": _fd_write, "memory": wasmMemory, "table": wasmTable};
var asm = createWasm();
